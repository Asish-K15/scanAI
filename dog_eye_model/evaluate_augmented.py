...
print("EFFICIENTNET-B0 TARGETED AUGMENTATION TEST EVALUATION")
print("=" * 60)
...
print()
print("=" * 60)
print("TARGETED AUGMENTATION TEST RESULTS")
print("=" * 60)
...
prediction_file = (
    OUTPUT_DIR
    / "efficientnet_b0_augmented_test_predictions.csv"
)
...
cm_file = (
    CM_DIR
    / "efficientnet_b0_augmented_confusion_matrix.csv"
)
...
summary = pd.DataFrame([{
    "model": "EfficientNet-B0 targeted augmentation",
...
summary_file = (
    OUTPUT_DIR
    / "efficientnet_b0_augmented_test_summary.csv"
)
...
print()
print("=" * 60)
print("TARGETED AUGMENTATION EVALUATION COMPLETE")
print("=" * 60)
