...
SOURCE = Path("expansion/dog_conjunctivitis")
OUT = Path("metadata/expansion_checks/dog_internal_duplicates.csv")
...
print("=" * 60)
print("DOG CONJUNCTIVITIS INTERNAL DUPLICATE CHECK")
print("=" * 60)
